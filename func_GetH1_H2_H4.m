function [H1, H2, H3, H4, isComplete] = func_GetH1_H2_H4(y, Fs, F0, handles, variables, textgridfile)
...
if (nargin == 5)
    ...
    for k=1:length(F0)
        ...
        [h3, dummy] = func_GetHarmonics(yseg, 3*F0_curr, Fs);
