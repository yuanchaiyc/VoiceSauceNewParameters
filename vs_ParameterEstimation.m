...
for k=1:length(filelist)
    ...
    % H1, H2, H3, H4    
        elseif (strcmp(paramlist{n}, 'H1, H2, H3, H4'))
            ...
            if (useTextgrid)
                [H1, H2, H3, H4, isComplete] = func_GetH1_H2_H4(y, Fs, F0, MBoxHandles, VSData.vars, textgridfile);
            else
                [H1, H2, H3, H4, isComplete] = func_GetH1_H2_H4(y, Fs, F0, MBoxHandles, VSData.vars);
            end
            ...
            if (exist(matfile, 'file'))
                save(matfile, 'H1', 'H2', 'H3', 'H4', 'HF0algorithm', '-append');    
            else
                save(matfile, 'H1', 'H2', 'H3', 'H4', 'HF0algorithm');
            end
    ...
    % A1, A2, A3
     ...
     % 1K
        elseif (strcmp(paramlist{n}, '1K'))
            messages{k} = [messages{k} '1K '];
            set(MBoxHandles.listbox_messages, 'String', messages, 'Value', k);
            drawnow;
            ...
            if (useTextgrid)
                [H1K, F1K, isComplete] = func_Get1K(y, Fs, F0, MBoxHandles, VSData.vars, textgridfile);
            else
                [H1K, F1K, isComplete] = func_Get1K(y, Fs, F0, MBoxHandles, VSData.vars);
            end
                        
            H1KFMTalgorithm = FMTalgorithm;
            
            save(matfile, 'H1K', 'F1K', 'H1KFMTalgorithm', '-append');

        elseif (strcmp(paramlist{n}, '1K5'))
            messages{k} = [messages{k} '1K5 '];
            set(MBoxHandles.listbox_messages, 'String', messages, 'Value', k);
            drawnow;
            ...
            if (useTextgrid)
                [H1K5, F1K5, isComplete] = func_Get1K5(y, Fs, F0, MBoxHandles, VSData.vars, textgridfile);
            else
                [H1K5, F1K5, isComplete] = func_Get1K5(y, Fs, F0, MBoxHandles, VSData.vars);
            end
                        
            H1K5FMTalgorithm = FMTalgorithm;
            
            save(matfile, 'H1K5', 'F1K5', 'H1K5FMTalgorithm', '-append');
    ...
    % 3K
        elseif (strcmp(paramlist{n}, '3K'))
            messages{k} = [messages{k} '3K '];
            set(MBoxHandles.listbox_messages, 'String', messages, 'Value', k);
            drawnow;
            ...
            if (useTextgrid)
                [H3K, F3K, isComplete] = func_Get3K(y, Fs, F0, MBoxHandles, VSData.vars, textgridfile);
            else
                [H3K, F3K, isComplete] = func_Get3K(y, Fs, F0, MBoxHandles, VSData.vars);
            end
                        
            H3KFMTalgorithm = FMTalgorithm;
            
            save(matfile, 'H3K', 'F3K', 'H3KFMTalgorithm', '-append');

    % 4K
        elseif (strcmp(paramlist{n}, '4K'))
            messages{k} = [messages{k} '4K '];
            set(MBoxHandles.listbox_messages, 'String', messages, 'Value', k);
            drawnow;
            ...
            if (useTextgrid)
                [H4K, F4K, isComplete] = func_Get4K(y, Fs, F0, MBoxHandles, VSData.vars, textgridfile);
            else
                [H4K, F4K, isComplete] = func_Get4K(y, Fs, F0, MBoxHandles, VSData.vars);
            end
                        
            H4KFMTalgorithm = FMTalgorithm;
            
            save(matfile, 'H4K', 'F4K', 'H4KFMTalgorithm', '-append');
    ...
    % 5K
        elseif (strcmp(paramlist{n}, '5K'))
            ...
            if (useTextgrid)
                [H5K, F5K, isComplete] = func_Get5K(y, Fs, F0, MBoxHandles, VSData.vars, textgridfile);
            else
                [H5K, F5K, isComplete] = func_Get5K(y, Fs, F0, MBoxHandles, VSData.vars);
            end
                        
            H5KFMTalgorithm = FMTalgorithm;
            
            save(matfile, 'H5K', 'F5K', 'H5KFMTalgorithm', '-append');            
